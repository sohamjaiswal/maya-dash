 ...
 */
function sendToAnalytics(metric: Metric, options: { path: any; params: any; analyticsId: any; debug?: any; }) {
 ...
 * @param {any} options
 */
export function webVitals(options: { path: string; params: Record<string, string>; analyticsId: any; }) {
  try {
